...
namespace Controller
{
	...
	typedef OSXController OSXControllerAccessor;

	class OSXController : public IEAController
	{
	public:
		...
		EACONTROLLER_API OSXController(ControllerIdType userID, EA::Allocator::ICoreAllocator* allocator, OSXControllerAccessor* accessor)
			: OSXController(userID, allocator) {}
		EA_RESTORE_VC_WARNING();
		EA_RESTORE_CLANG_WARNING();

		EACONTROLLER_API OSXController(ControllerIdType userID, EA::Allocator::ICoreAllocator* allocator);
		EACONTROLLER_API virtual ~OSXController() = default;
